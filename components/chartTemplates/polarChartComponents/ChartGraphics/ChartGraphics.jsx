    ...
    >
      {
        Object.keys(dataObject.influencerScore).map((item, index) => {
          ...
          console.log(`Current Distance: ${currentValues.distanceFromCenter}`);
          console.log(`Next Distance: ${nextValues.distanceFromCenter}`);
          console.log(`First Distance: ${firstValues.distanceFromCenter}`);
          ...
          const angleToNextPoint = 
            ...
            console.log(`Distance to next point: ${distanceToNextPoint}`);
            console.log(' ');
          return (
            <View
